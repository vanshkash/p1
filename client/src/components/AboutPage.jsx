        ...
        >
          ...
          >
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              India’s most electrifying mobile DJ brand, delivering immersive audio-visual experiences
              for weddings, festivals, corporate events, and concerts. We don’t just play music—we
              orchestrate moments.
            </p>
            <div className="mt-6">
          ...
          >
            <motion.div
              className="bg-neutral-900 p-6 rounded-xl border-l-4 border-yellow-400 shadow-md hover:shadow-yellow-500/20 transition"
              variants={fadeInUp}
            >
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">🎯 Our Mission</h2>
              <p className="text-gray-300 leading-relaxed">
                To transform every celebration into a high-impact experience through curated sound,
                dynamic visuals, and seamless execution. We believe in authenticity, inclusivity, and
                scalable excellence.
              </p>
            </motion.div>

            <motion.div
              className="bg-neutral-900 p-6 rounded-xl border-l-4 border-pink-500 shadow-md hover:shadow-pink-500/20 transition"
              variants={fadeInUp}
            >
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed bg-neutral-900 p-6 rounded-xl border-l-4 border-red-500 shadow-md hover:shadow-red-500/20 transition">
              Headquarter in Hapur, we serve clients across Delhi NCR, Uttar Pradesh, and pan-India.
              Whether it’s a baraat in Agra, a college fest in Lucknow, or a corporate gala in
              Mumbai—ANIL DJ & EVENTS brings the beats, the visuals, and the vibe.
            </p>
          </motion.section>
          ...
          >
            ...
            <p className="text-gray-400 mt-4 max-w-xl mx-auto">
              Ready to turn up the volume on your next celebration? Connect with us to craft an
